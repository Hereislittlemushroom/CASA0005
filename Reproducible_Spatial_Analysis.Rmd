...
# # ggplot2
# distribute_df = df
# distribute_df$year = as.String(distribute_df$year)
# 
# library(ggplot2)
# 
# ggplot(data = distribute_df)+
#   geom_bar(aes(x=distribute_df$county, fill=distribute_df$year),  color='white')+ # add in the bars 
#   coord_flip()+ # switch orientation of the axes to easier reading of the labels 
#   theme_minimal()+ # basic formatting 
#   xlab('Boroughs')+ # change the x axis label
#   ylab('Frequency')+ # change the y axis label
#   guides(fill=guide_legend(title='Year'))+ # change legend title 
